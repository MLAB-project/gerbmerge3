...
if __name__ == "__main__":
    ...
    assert intersectExtents((100, 100, 500, 500), (500, 500, 900, 900)) is None
    ...
    assert intersectExtents((100, 100, 500, 500), (0, 600, 50, 550)) is None
    ...
    assert isRect1InRect2((100, 100, 500, 500), (0, 600, 50, 550)) is False
    assert isRect1InRect2((100, 100, 500, 500), (0, 600, 600, -10)) is True
    assert isRect1InRect2((100, 100, 500, 500), (0, 600, 600, 200)) is False
    assert isRect1InRect2((100, 100, 500, 500), (0, 600, 300, 300)) is False
    assert isRect1InRect2((100, 100, 500, 500), (0, 0, 500, 500)) is True
